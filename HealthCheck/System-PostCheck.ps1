...
.DESCRIPTION
    Server-Postcheck utilizes WMI to retrieve information related to the physical hardware of the machine(s), the available `
    disk space, when the machine(s) last restarted and bundles all that information up into a colored HTML report.
.EXAMPLE
   Server-Postcheck -Computername localhost, SRV-2012R2, DC-01, DC-02
...
param([Parameter(Mandatory=$false,
      ...
      [string]$FilePath = "C:\ostc\Postcheck\Postcheck.html",
...
$Hardware1 | epcsv C:\ostc\Postcheck\Hardware_Post.Csv -NoTypeInformation -Append
...
$PercentFree1 |Export-Csv C:\OSTC\Postcheck\Disk_Post.csv -NoTypeInformation -Append
...
$auto_Services1 |epcsv C:\OSTC\Postcheck\Services_Post.csv -NoTypeInformation -Append
...
$ipdata1|epcsv C:\OSTC\Postcheck\IpDetails_Post.csv -NoTypeInformation -Append
...
$avData1 |epcsv C:\OSTC\Postcheck\AVDetails_Post.csv -NoTypeInformation -Append
...
$Report = ConvertTo-Html -Title "$Computername" `
                         ...
                         -Body "$Hardware $PercentFree $Restarted $Patches $avData $ipdata $fileShare $auto_Services $Css" 
...
$routeprinttemp | out-file "C:\OSTC\Postcheck\routeprint.txt"
}
...
$Ipconfig | out-file "C:\OSTC\Postcheck\Ipconfig_Post.txt"
}
